...
_LAYOUTS: tuple[Layout, ...] = (
    ...
    # NVIDIA Nemotron 3 Nano (NemotronHForCausalLM). Its hybrid
    # Mamba/attention/MoE stack is exposed as ``backbone.layers`` and uses
    # non-Llama names for both the token embedding and final norm.
    Layout("backbone", norm="norm_f", embed="embeddings"),
